...
public class AdvancedInscriberXMenu extends UpgradeableMenu<BEAdvancedInscriberX>
        implements IProgressProvider, IUpgradeableObject {

    public static MenuType<AdvancedInscriberXMenu> ADVANCED_INSCRIBER_SHT = MenuTypeBuilder
            .create(AdvancedInscriberXMenu::new, BEAdvancedInscriberX.class).build("advanced_inscriber_x");
    ...
    public AdvancedInscriberXMenu(int syncId, Inventory playerInventory, BEAdvancedInscriberX advancedInscriber) {
    ...
    public boolean isValidForSlot(Slot s, ItemStack is) {
        ...
        if (s == this.middle) {
            ...
            return XRecipes.findRecipe(world, is, top, bot, false) != null;
            ...
            return XRecipes.isValidOptionalIngredientCombination(world, is, otherSlot);
        }
        return true;
    }

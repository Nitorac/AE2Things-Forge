...
public class BEAdvancedInscriberX extends AENetworkPowerBlockEntity implements IGridTickable, IUpgradeableObject {
    ...
    public BEAdvancedInscriberX(BlockPos pos, BlockState state) {
        super(AE2Things.ADVANCED_INSCRIBER_X_BE.get(), pos, state);

        this.upgrades = UpgradeInventories.forMachine(AE2Things.ADVANCED_INSCRIBER_X.get(), 7, this::saveChanges);
    ...
    public InscriberRecipe getTask() {
        if (this.cachedTask == null && level != null) {
            ...
            this.cachedTask = XRecipes.findRecipe(level, input, plateA, plateB, true);
        }
    ...
    public class FilteredInventory implements IAEItemFilter {
        ...
        public boolean allowInsert(InternalInventory inv, int slot, ItemStack stack) {
            ...
            if (inv == BEAdvancedInscriberX.this.topItemHandler || inv == BEAdvancedInscriberX.this.botItemHandler) {
            ...
            for (var recipe : XRecipes.getRecipes(getLevel())) {
